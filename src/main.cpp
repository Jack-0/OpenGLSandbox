...
int main()
{
    ...
    // shader programs
    Shader lightingShader("../res/shaders/light_map.vert", "../res/shaders/light_map.frag");
    ...
    // load textures
    unsigned int diffuseMap  = createTexture("../res/textures/container.png");
    unsigned int specularMap = createTexture("../res/textures/container_specular.png");
